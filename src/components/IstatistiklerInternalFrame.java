...
public class IstatistiklerInternalFrame extends javax.swing.JInternalFrame {
    ...
    /**
     * Creates new form IstatistiklerInternalFrame
     */
    ...
    private void initComponents() {
        ...
        istatistikTablosu.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "PERSONEL", "BUGÜN", "GENEL", "BEKLEYEN İŞ"
            }
        ) {
        ...
        onPanelLayout.setHorizontalGroup(
            onPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(onPanel, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        );
    ...
    private void istatistikleriYukle() {
        try {              
            ...
            while (rs.next()){
                model.addRow(new Object[]{rs.getString("ad")+" "+rs.getString("soyad"),rs.getString("yetki"), rs.getString("yetki"), rs.getString("gorev")});
            }
            conn.close();
            pst = null;
            rs = null;
